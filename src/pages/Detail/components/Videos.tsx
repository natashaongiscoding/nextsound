    ...
    >
      {youtubeVideos.map((video) => {
        return (
          ...
          >
            <h2 className="dark:text-sec-color text-gray-800 font-nunito font-semibold lg:text-[24px] md:text-[22.75px] sm:text-[18.75px] xs:text-[18px] text-[16.75px] mb-1">
              {video.name}
            </h2>
            <div className="w-full lg:h-[480px] md:h-[420px] sm:h-[320px] h-[210px] rounded-md mx-auto shadow-lg">
              <iframe
